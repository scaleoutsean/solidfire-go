...
//
// Go implementation of "parallel backup to S3" script from
// https://github.com/scaleoutsean/awesome-solidfire/blob/master/scripts/parallel-backup-to-s3-v2.ps1
// This example uses a private API call to get the slices.json report
// to map volumes to nodes for better scheduling.
